    ...
    <section className="about" id="about">
      ...
      <div className="about-card fade-in show">
        <div className="about-container">
          <h2>About Me</h2>
          <p>
            I’m a Computer Science student passionate about building real, working software and continuously improving my technical skills.
            ...
            I’m looking for opportunities where I can apply my skills, learn from experienced developers, and grow into a strong software engineer — whether through internships, collaborative projects, or entry-level roles.
